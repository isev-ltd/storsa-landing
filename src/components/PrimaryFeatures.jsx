...
import screenshotWebApp from '@/images/screenshots/web-app.png'
import screenshotWebExtension from '@/images/screenshots/web-extension.png'
      ...
      <Container className="relative bg-rose-600">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          ...
          <p className="mt-6 text-lg tracking-tight text-rose-100">
            Keep your bookmarks synced between multiple devices and discover new links from teammates.
          </p>
        </div>
        <Tab.Group
          as="div"
